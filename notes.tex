...
\section{Culture organisationnelle}
	...
	\subsection{Méthodologies d'étude}
		...
		L'entreprise \textbf{EST une culture} : approches qualitatives, idiosyncrasiques, cliniques et ethnographiques. \newline
		
		L'entreprise \textbf{A une culture} : approches quantitatives, nomothétiques, par questionnaires.
